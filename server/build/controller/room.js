...
exports.getRoomById = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (isAuthor || isParticipant) {
        return res.status(201).json(new apiResponse_1.ApiResponse(201, "Room found", { room, isAllowed: true }, true));
    }
    else {
        const sanitizedRoom = {
            _id: room._id,
        ...
        return res.status(201).json(new apiResponse_1.ApiResponse(201, "Room found (Awaiting Admission)", { room: sanitizedRoom, isAllowed: false }, true));
    }
}));
exports.joinRoom = (0, asyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!p.find((e) => e.id.toString() === userId.toString())) {
