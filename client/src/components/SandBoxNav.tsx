    ...
    <div className="flex justify-end items-center py-3 space-x-1 md:space-x-3 px-5 border-t-2 border-b-2 border-slate-700 bg-slate-900 ">
      ...
      {room && (
        <button
          ...
          className="bg-indigo-600 hover:bg-indigo-500 text-sm flex items-center px-3 py-1.5 rounded-lg text-white font-semibold transition-all duration-200 gap-1.5 shadow-md shadow-indigo-600/10 border border-indigo-500/20"
